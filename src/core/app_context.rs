...
pub struct AppContext<Value> {
    ...
    pub http_data_loaders: Arc<Vec<DataLoader<DataLoaderRequest, HttpDataLoader<async_graphql::Value>>>>,
    pub gql_data_loaders: Arc<Vec<DataLoader<DataLoaderRequest, GraphqlDataLoader<async_graphql::Value>>>>,
    pub grpc_data_loaders: Arc<Vec<DataLoader<grpc::DataLoaderRequest, GrpcDataLoader<async_graphql::Value>>>>,
